...
javac code/loops/LabChallenge.java 
...
OUTPUT1=("$(java -cp code/loops/ LabChallenge)")
if [ -z "$OUTPUT1" ]; then
  echo "<br/><hr/><h3>Challenge Feedback</h3>"
  echo "Your code does not seem to be outputting anything. Make sure you are using: <code>for</code>, <code>System.out.print()</code>, and <code>System.out.println()</code> to print the requested pattern."
  exit 1;
