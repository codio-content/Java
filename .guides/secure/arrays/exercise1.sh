...
javac code/arrays/Exercise1.java
...
OUTPUT1=("$(java -cp code/arrays/ Exercise1)")
if [ -z "$OUTPUT1" ]; then
  echo "<br/><hr/><h3>Challenge Feedback</h3>"
  echo "Your code does not seem to be outputting anything. Make sure you are using correct array syntax to print the specified elements."
  exit 1;
elif [ "$OUTPUT1" != "Pacific
Atlantic
Indian
Arctic
Southern" ]; then 
...
python3 .guides/secure/arrays/exercise1_check1.py
if [ $? -ne 0 ]; then 
