...
javac code/methods/Exercise5.java
...
OUTPUT1=("$(java -cp code/methods/ Exercise5 0)") #Testing
OUTPUT2=("$(java -cp code/methods/ Exercise5 1)")
OUTPUT3=("$(java -cp code/methods/ Exercise5 Level)")
OUTPUT4=("$(java -cp code/methods/ Exercise5 anna)")
OUTPUT5=("$(java -cp code/methods/ Exercise5 022220)")
OUTPUT6=("$(java -cp code/methods/ Exercise5 YaAy)")
...
python3 .guides/secure/methods/exercise5_check1.py
if [ $? -ne 0 ]; then 
